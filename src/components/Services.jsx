        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <div className="relative z-1 max-w-[25rem] ml-auto">
              <h4 className="mb-4 h4">{t("Services.ServiceTitle1")}</h4>
              <p className="body-2 mb-[3rem] text-n-3">
                {t("Services.ServiceTitle2")}
              </p>
              <ul className="body-2">
                <li className="flex items-start py-4 border-t border-n-6">
                  <img width={24} height={24} src={check} />
                  <p className="ml-4">{t("Services.ServiceDescription1")}</p>
                </li>
                <li className="flex items-start py-4 border-t border-n-6">
                  <img width={24} height={24} src={check} />
                  <p className="ml-4">{t("Services.ServiceDescription2")}</p>
                </li>
                <li className="flex items-start py-4 border-t border-n-6">
                  <img width={24} height={24} src={check} />
                  <p className="ml-4">{t("Services.ServiceDescription3")}</p>
                </li>
              </ul>
            </div>
